...
**Canonical product, repo and Python package name: `nfcraft`.** This is the continuation of NFC Card Ops, not an invitation to generate a second repository. Start in the current repository root. Current local version: **0.2.2**, still an unqualified hardware prototype.
